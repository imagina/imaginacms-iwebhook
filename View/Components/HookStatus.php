...
class HookStatus extends Component
{
  ...
  public function __construct($id = null, $params = [], $classes = null, $title = "", $titleAlign = "text-left",
                              $titleColor = null, $titleColorClasses = 'text-primary', $titleSize = null,
                              $titleWeight = "font-weight-normal", $titleTransform = null, $titleLetterSpacing = 0,
                              $titleClasses = "", $tableResponsive = 'table-responsive', $tableSize = '',
                              $tableClasses = '', $linkTarget = "_blank", $theadClasses = "", $tbodyClasses = "",
                              $theadStyles = null, $tbodyStyles = null, $onlineLabelColor = '#28a745',
                              $offlineLabelColor = '#6c757d', $textLabelColor = '#ffffff', $colorLink = "#333333",
                              $paging = false, $ordering = false, $searching = true, $info = false,
                              $lengthChange = false, $pagingType = 'simple_numbers', $datatables = true,
                              $columnDefs = null, $lengthMenu = null
  )
  {
